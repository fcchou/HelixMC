...
def wlc_odijk(F, A, L, S, kT=kBT):
    ...
    .. math::
       z = L \left( 1 - \frac{1}{2} \sqrt{ \frac{k T}{F A} } + \frac{F}{S} \right)
...
def wlc_bouchiat(A, L, z, kT=kBT):
    ...
    .. math::
       F = \frac{kT}{A} \left[ \frac{1}{4 (1 - z / L)^2} - \frac{1}{4} + \frac{z}{L} +
       \sum\limits_{i=2}^{i \le 7}{ \alpha_i {\left( \frac{z}{L}  \right)}^i} \right]
...
def wlc_bouchiat_impl(A, L, S, z, F, kT=kBT):
    ...
    .. math::
       \log_{10} \left[  \frac{kT}{A} \left( \frac{1}{4(1-l)^2} - \frac{1}{4} + l +
